...
| バージョン | 日付 | 変更内容 |
| --- | --- | --- |
| **0.1.13** | 2026-08-29 | **ワンクリックスタイルプリセット 4 種**を追加（顔文字かわいい / アイルー / ネコ娘 / DeepSeekちゃん——タイトル + 5 理由の文面一式をスタイル化した簡体中文）。プリセットドロップダウンから廃止済みの旧テンプレート名（playful/formal/detail）を整理 |

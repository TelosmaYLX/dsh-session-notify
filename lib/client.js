    ...
    function makeSettingsCard(react, ctx) {
      ...
      function ChipEditor(props) {
        ...
        return h('div', {
          ...
          style: {
            minHeight: '36px', padding: props.compact ? '5px 8px' : '7px 10px', borderRadius: '8px',
            border: '1px solid var(--dsw-alias-border-l2, rgba(127,127,127,0.35))',
            background: 'transparent', color: 'inherit', font: 'inherit', fontSize: '13px',
              ...
              h('div', { style: { display: 'flex', alignItems: 'center', gap: '8px' } },
                ...
                h('div', { style: { flex: 1, minWidth: 0 } },
                  h(ChipEditor, {
                    ...
                    lang: cur.language,
                    compact: true,
                    placeholder: t.placeholder, // 空模板显示占位提示（不再把默认文案当内容渲染，避免「删空后自动复原」的错觉）
                    imageData: imageOf(cur, field),
                    iconData: iconOf(cur, field),
                ...
                h('button', {
                  ...
                  style: iconBtn,
                }, h('svg', { width: '14', height: '14', viewBox: '0 0 24 24', fill: 'currentColor', style: { display: 'block', transform: 'rotate(-30deg)' } },

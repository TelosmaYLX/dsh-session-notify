  ...
  factory: (require) => {
    ...
    var I18N = {
      zh: {
        ...
        presets: { custom: '自定义预设', unnamed: '未命名预设', default: '默认', kaomoji: '颜文字可爱', felyne: '艾露猫', neko: '猫娘', deepseekChan: 'DeepSeek 娘' },
      ...
      'zh-tw': {
        ...
        presets: { custom: '自訂預設', unnamed: '未命名預設', default: '預設', kaomoji: '顏文字可愛', felyne: '艾露貓', neko: '貓娘', deepseekChan: 'DeepSeek 娘' },
      ...
      en: {
        ...
        presets: { custom: 'Custom preset', unnamed: 'Untitled preset', default: 'Default', kaomoji: 'Kaomoji cute', felyne: 'Felyne (MH cat)', neko: 'Neko girl', deepseekChan: 'DeepSeek-chan' },
      ...
      ja: {
        ...
        presets: { custom: 'カスタムプリセット', unnamed: '未命名プリセット', default: 'デフォルト', kaomoji: '顔文字かわいい', felyne: 'アイルー', neko: 'ネコ娘', deepseekChan: 'DeepSeekちゃん' },
      ...
      ko: {
        ...
        presets: { custom: '사용자 지정 프리셋', unnamed: '이름 없는 프리셋', default: '기본', kaomoji: '카오모지 귀여움', felyne: '아이루', neko: '네코무스메', deepseekChan: 'DeepSeek짱' },
    ...
    function makeSettingsCard(react, ctx) {
      ...
      function matchesPreset(cur, p) {
        ...
        for (var j = 0; j < REASON_FIELDS.length; j++) {
          if (templateOf(cur, REASON_FIELDS[j]) !== String(pt[REASON_FIELDS[j]] ?? '').trim()) return false
          if (titleTplOf(cur, REASON_FIELDS[j]) !== String(ptt[REASON_FIELDS[j]] ?? '').trim()) return false
        }
        return true
      }

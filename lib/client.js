      ...
      return function SettingsCard() {
        ...
        if (!ready) {
          ...
          if (tplOpen) {
            ...
            // 一行式：原因标签 + Chip 编辑器 + 「+/−」插入菜单按钮 + 纸飞机发送按钮（预览在行下方小字）
            var iconBtn = {
              appearance: 'none', width: '26px', height: '26px', borderRadius: '50%', padding: '0', flex: 'none',
              border: '1px solid var(--dsw-alias-border-l2, rgba(127,127,127,0.35))',
            ...
            rows.push(h('div', {
              key: 'tpl-' + field,
              style: { display: 'flex', flexDirection: 'column', gap: '4px', padding: '6px 0', borderTop: DIVIDER },
            },
              h('div', { style: { display: 'flex', alignItems: 'center', gap: '8px' } },
                ...
                h('button', {
                  ...
                  style: iconBtn,
                }, h('svg', { width: '14', height: '14', viewBox: '0 0 24 24', fill: 'currentColor', style: { display: 'block' } },
                  h('path', { d: 'M2.01 21 23 12 2.01 3 2 10l15 2-15 2z' }))),
              ),
              menuFor === field
                ? h('div', {
                  key: 'menu-' + field,

          ...
          if (tplOpen) {
            ...
            rows.push(h('div', {
              ...
              h('div', { style: { display: 'flex', alignItems: 'center', gap: '8px' } },
                h('span', { style: { flex: 'none', whiteSpace: 'nowrap', fontSize: '12px', color: 'var(--dsw-alias-label-tertiary, rgba(127,127,127,0.8))' } }, t.fields[field]),
                ...
                h('button', {
                  ...
                  style: iconBtn,
                }, h('svg', { width: '14', height: '14', viewBox: '0 0 24 24', fill: 'currentColor', style: { display: 'block', transform: 'rotate(-60deg)' } },

  ...
  factory: (require) => {
    ...
    var I18N = {
      ...
      'zh-tw': {
        ...
        saveAs: '新增', rename: '重命名', update: '修改', remove: '刪除', presetNamePlaceholder: '預設名稱', confirm: '確定', cancel: '取消', customSaved: '自訂預設已儲存', customUpdated: '自訂預設已更新', customDeleted: '自訂預設已刪除', saveAsTitle: '將當前設定另存為自訂預設', renameTitle: '重新命名目前自訂預設', updateTitle: '更新目前自訂預設', removeTitle: '刪除目前自訂預設', fromPreset: '來自：', modifiedSuffix: ' · 已修改',

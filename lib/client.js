  ...
  factory: (require) => {
    ...
    var I18N = {
      zh: {
        ...
        kindLabels: { completed: '会话已完成', error: '会话出错', aborted: '会话已中止', blocked: '会话被阻塞', 'max-tokens': '会话达到上限', question: 'AI 向你提问：{question}' },
      ...
      'zh-tw': {
        ...
        kindLabels: { completed: '會話已完成', error: '會話出錯', aborted: '會話已中止', blocked: '會話被阻塞', 'max-tokens': '會話達到上限', question: 'AI 向你提問：{question}' },
      ...
      en: {
        ...
        kindLabels: { completed: 'Session completed', error: 'Session failed', aborted: 'Session aborted', blocked: 'Session blocked', 'max-tokens': 'Session hit the cap', question: 'AI is asking: {question}' },
      ...
      ja: {
        ...
        kindLabels: { completed: 'セッション完了', error: 'セッションエラー', aborted: 'セッション中止', blocked: 'セッションがブロックされました', 'max-tokens': '上限に到達', question: 'AI からの質問：{question}' },
      ...
      ko: {
        ...
        kindLabels: { completed: '세션 완료', error: '세션 오류', aborted: '세션 중단됨', blocked: '세션 차단됨', 'max-tokens': '한도 도달', question: 'AI가 질문합니다: {question}' },
    ...
    exports.apply = function apply(ctx) {
      ...
      function checkQuestion(id, s) {
        if (s.origin === 'subagent') return // 子代理不能直接向人类提问
        var pv = null
        try {

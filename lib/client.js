  ...
  factory: (require) => {
    ...
    exports.apply = function apply(ctx) {
      ...
      function checkQuestion(id, s) {
        ...
        var title = (typeof pv.title === 'string' && pv.title.trim() !== '') ? pv.title.trim() : (name ? name + ' 想问你' : '有新的提问')
        var body = (name ? '会话「' + name + '」想问你：\n' : '') + pv.text
    ...
    function makeSettingsCard(react, ctx) {
      ...
      var PRESETS = [
        ...
        // 载入/切换语言时自动取当前语言的文案（缺语言回退 zh）
        {
          ...
          i18n: {
            zh: {
              titleTemplates: { completed: '任务完成 (＾▽＾)', error: '任务出错 (；д；)', aborted: '任务中止 (；ω；)', blocked: '任务被阻塞 (・_・;)', 'max-tokens': '任务到上限 (￣▽￣)' },
              templates: {
            ...
            'zh-tw': {
              titleTemplates: { completed: '任務完成 (＾▽＾)', error: '任務出錯 (；д；)', aborted: '任務中止 (；ω；)', blocked: '任務被阻塞 (・_・;)', 'max-tokens': '任務到上限 (￣▽￣)' },
              templates: {
            ...
            en: {
              titleTemplates: { completed: 'Task done (＾▽＾)', error: 'Task failed (；д；)', aborted: 'Task aborted (；ω；)', blocked: 'Task blocked (・_・;)', 'max-tokens': 'Task hit the cap (￣▽￣)' },
              templates: {
            ...
            ja: {
              titleTemplates: { completed: 'タスク完了 (＾▽＾)', error: 'タスクエラー (；д；)', aborted: 'タスク中止 (；ω；)', blocked: 'タスクブロック (・_・;)', 'max-tokens': '上限到達 (￣▽￣)' },
              templates: {
            ...
            ko: {
              titleTemplates: { completed: '작업 완료 (＾▽＾)', error: '작업 오류 (；д；)', aborted: '작업 중단 (；ω；)', blocked: '작업 차단 (・_・;)', 'max-tokens': '한도 도달 (￣▽￣)' },
              templates: {

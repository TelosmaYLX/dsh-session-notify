 ...
 * 占位符：{label} 标签、{errBlock} 错误详情块（含分隔符，无错误为空）、{dur} 用时、{use} 消耗。
 * 仅当用时与消耗都有数据时启用；数据不全回退到 buildNotice 的 parts 拼接逻辑（自动省略缺失项）。
 */
const DEFAULT_PHRASES = {
  zh: {
    completed: '{label}（用时 {dur}，消耗 {use}）。',
    aborted: '{label}。用时 {dur}，消耗 {use}。',
    blocked: '{label}。用时 {dur}，消耗 {use}。',
    error: '{label}{errBlock}（用时 {dur}，消耗 {use}）。',
    'max-tokens': '{label}。用时 {dur}，消耗 {use}，建议拆分任务后重试。',
    generic: '{label}。用时 {dur}，消耗 {use}。',
  },
  'zh-tw': {
    completed: '{label}（用時 {dur}，消耗 {use}）。',
    aborted: '{label}。用時 {dur}，消耗 {use}。',
    blocked: '{label}。用時 {dur}，消耗 {use}。',
    error: '{label}{errBlock}（用時 {dur}，消耗 {use}）。',
    'max-tokens': '{label}。用時 {dur}，消耗 {use}，建議拆分任務後重試。',
    generic: '{label}。用時 {dur}，消耗 {use}。',
  },
  en: {
    completed: '{label} (took {dur}, used {use}).',
    aborted: '{label}. Took {dur}, used {use}.',
    blocked: '{label}. Took {dur}, used {use}.',
    error: '{label}{errBlock} (took {dur}, used {use}).',
    'max-tokens': '{label}. Took {dur}, used {use} — consider splitting the task.',
    generic: '{label}. Took {dur}, used {use}.',
  },
  ja: {
    completed: '{label}（所要 {dur}、消費 {use}）。',
    aborted: '{label}。所要 {dur}、消費 {use}。',
    blocked: '{label}。所要 {dur}、消費 {use}。',
    error: '{label}{errBlock}（所要 {dur}、消費 {use}）。',
    'max-tokens': '{label}。所要 {dur}、消費 {use}。タスクの分割をおすすめします。',
    generic: '{label}。所要 {dur}、消費 {use}。',
  },
  ko: {
    completed: '{label}（소요 {dur}, 소모 {use}）。',
    aborted: '{label}. 소요 {dur}, 소모 {use}.',
    blocked: '{label}. 소요 {dur}, 소모 {use}.',
    error: '{label}{errBlock}（소요 {dur}, 소모 {use}）.',
    'max-tokens': '{label}. 소요 {dur}, 소모 {use} — 작업 분할을 권장합니다.',
    generic: '{label}. 소요 {dur}, 소모 {use}.',
  },
}

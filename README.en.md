...
| --- | --- | --- |
| **0.1.13** | 2026-08-29 | Added **4 one-click style presets** (kaomoji cute / Felyne / Neko girl / DeepSeek-chan — a full set of stylized simplified-Chinese copy for the title + all 5 reasons); cleaned the obsolete old template names (playful/formal/detail) out of the preset dropdown |
